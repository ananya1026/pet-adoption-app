...
async function seed() {
  const uri = `mongodb://${process.env.DB_HOST}:${process.env.DB_PORT}/petdb`;
  ...
  try {
    ...
    const petsData = [
      {
        _id: new MongoClient.ObjectId('670000000000000000000001'),
        name: 'Buddy',
        type: 'Dog',
        species: 'Dog',
      ...
      {
        _id: new MongoClient.ObjectId('670000000000000000000002'),
        name: 'Luna',
        type: 'Cat',
        species: 'Cat',
        breed: 'Persian Cat',
      ...
      {
        _id: new MongoClient.ObjectId('670000000000000000000003'),
        name: 'Snowball',
        type: 'Rabbit',
        species: 'Rabbit',
        breed: 'White Rabbit',
      ...
      {
        _id: new MongoClient.ObjectId('670000000000000000000004'),
        name: 'Max',
        type: 'Cat',
        species: 'Cat',
        breed: 'Black Cat',
      ...
      {
        _id: new MongoClient.ObjectId('670000000000000000000005'),
        name: 'Sheru',
        type: 'Dog',
        species: 'Dog',
        breed: 'White Dog',
      ...
      {
        _id: new MongoClient.ObjectId('670000000000000000000006'),
        name: 'Balu',
        type: 'Bear',
        species: 'Bear',
        breed: 'Polar Bear',
      ...
      {
        _id: new MongoClient.ObjectId('670000000000000000000007'),
        name: 'Buddy Jr.',
        type: 'Dog',
        species: 'Dog',
      ...
      {
        _id: new MongoClient.ObjectId('670000000000000000000008'),
        name: 'Mittens',
        type: 'Cat',
        species: 'Cat',
        breed: 'Tabby',
      ...
      {
        _id: new MongoClient.ObjectId('670000000000000000000009'),
        name: 'Coco',
        type: 'Rabbit',
        species: 'Rabbit',
        breed: 'Mini Lop',
      ...
      {
        _id: new MongoClient.ObjectId('67000000000000000000000A'),
        name: 'Polly',
        type: 'Parrot',
        species: 'Parrot',
        breed: 'African Grey',
      ...
      {
        _id: new MongoClient.ObjectId('67000000000000000000000B'),
        name: 'Nemo',
        type: 'Fish',
        species: 'Fish',
        breed: 'Clownfish',
      ...
      {
        _id: new MongoClient.ObjectId('67000000000000000000000C'),
        name: 'Shelly',
        type: 'Turtle',
        species: 'Turtle',
    ...
    await pets.insertMany(petsData);
    ...
    console.log('✅ Database seeded with pets and admin user');
  } catch (err) {
